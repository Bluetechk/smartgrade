-- Fix type mismatch in calculate_period_totals trigger
-- v_period was declared as TEXT instead of period_type enum
-- This caused the WHERE clause to fail silently, returning 0 rows
